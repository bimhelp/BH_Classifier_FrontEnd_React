...
`;var l=r(3535),d=r(2187),c=r(4330),u=r(2564),b=r(334),h=r(184);const m=e=>{let{submit:t,isLoading:r,back:n,isSubmiting:m}=e;const[x,y]=(0,s.useState)(""),j=e=>{e.preventDefault(),x.trim().length<1?u.Am.error("\u0412\u0432\u0435\u0434\u0456\u0442\u044c \u0437\u0430\u043f\u0438\u0442 \u0432 \u043f\u043e\u043b\u0435 \u043f\u043e\u0448\u0443\u043a\u0443"):t(x.trim())};return(0,h.jsxs)(h.Fragment,{children:[(0,h.jsxs)(a,{onSubmit:j,children:[(0,h.jsx)(l.xE,{icon:c.Zyb,type:"button",onClick:()=>{y(""),n()}}),(0,h.jsx)(i,{children:(0,h.jsx)(o,{name:"search",type:"text",onChange:e=>{const t=e.currentTarget.value.toLowerCase();y(t)},value:x})}),(0,h.jsx)(l.QZ,{icon:d.eaK,type:"submit",onClick:j,disabled:m})]}),r&&(0,h.jsx)(b.Z,{color:"#125b56",width:"100%"})]})}},1870:(e,t,r)=>{r.d(t,{Z:()=>i});r(2791);var s=r(3703),n=r(2631),a=r(184);const i=e=>{let{results:t,query:r,variant:i,byId:o}=e;return"material"===i?(0,a.jsx)("div",{children:t.length>0&&(0,a.jsx)(s.Z,{items:t,query:r,byId:o})}):"service"===i?(0,a.jsx)("div",{children:t.length>0&&(0,a.jsx)(n.Z,{items:t,query:r,byId:o})}):void 0}},9592:(e,t,r)=>{r.r(t),r.d(t,{default:()=>g});var s=r(2791),n=r(3703),a=r(9787),i=r(2564),o=r(334),l=r(2978);const d=l.ZP.div`
  /* outline: 2px solid red; */
  margin-left: -${e=>e.theme.space[3]}px;
`;var c=r(1840),u=r(184);const b=e=>{let{byId:t}=e;const[r,l]=(0,s.useState)([]),[b,h]=(0,s.useState)(!1);return(0,s.useEffect)((()=>{const e=new AbortController;return async function(){try{h(!0);const t=await(0,a.H0)(2,e.signal);l(t.data)}catch{i.Am.error("\u0429\u043e\u0441\u044c \u043f\u0456\u0448\u043b\u043e \u043d\u0435 \u0442\u0430\u043a, \u0441\u043f\u0440\u043e\u0431\u0443\u0439\u0442\u0435 \u043f\u0435\u0440\u0435\u0437\u0430\u0432\u0430\u043d\u0442\u0430\u0436\u0438\u0442\u0438 \u0441\u0442\u043e\u0440\u0456\u043d\u043a\u0443")}finally{h(!1)}}(),()=>{l([]),e.abort()}}),[l]),(0,u.jsx)(u.Fragment,{children:b?(0,u.jsx)(o.Z,{color:"#125b56",width:"100%"}):(0,u.jsxs)(d,{children:[(0,u.jsx)(n.Z,{items:r,style:{padding:0},byId:t}),(0,u.jsx)(c.Z,{})]})})};var h=r(7111),m=r(9966),x=r(1870),y=r(6334),j=r(6655);const f=l.ZP.div`
  max-height: 85vh;
`,p=l.ZP.div`
  display: flex;
  gap: 10px;
...
//# sourceMappingURL=592.5662b8fb.chunk.js.map